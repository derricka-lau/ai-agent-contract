...
verify_installed() {
  ...
  check "Codex workspace-write installed" grep -Fq 'sandbox_mode = "workspace-write"' "$HOME/.codex/config.toml"
  check "Codex network remains disabled" grep -Fq 'network_access = false' "$HOME/.codex/config.toml"
